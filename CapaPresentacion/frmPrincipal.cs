...
namespace CapaPresentacion
{
    public partial class frmPrincipal : Form
    {
        ...
        private void mantenimeintoToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        {
            //Controlar los accesor
            if(Acceso=="Administrador")
            {
                this.MnuAlmacen.Enabled = true;
                this.MnuCompra.Enabled=true;
        ...
        private void btnStockArticulos_Click(object sender, EventArgs e)
        {
            Consultas.frmConsulta_Stock_Articulos frm = new Consultas.frmConsulta_Stock_Articulos();
            frm.MdiParent = this;
            frm.Show();
