...
namespace CapaDatos
{
    public class DDetalle_Ingresos
    {
        ...
        public DDetalle_Ingresos(int iddetalle_ingreso,int idingreso,
            int idarticulo,decimal precio_compra,decimal precio_venta,
            int stock_inicial,int stock_actual,DateTime fecha_ingreso,
        ...
        //Metodo Insertar 
        public string Insertar(DDetalle_Ingresos Detalle_Ingreso,
            ref SqlConnection SqlCon,ref SqlTransaction SqlTra)
        {
            ...
            try
            {
                ...
                ParFecha_Ingreso.SqlDbType = SqlDbType.Date;
                ParFecha_Ingreso.Value = Detalle_Ingreso.Fecha_Ingreso;
